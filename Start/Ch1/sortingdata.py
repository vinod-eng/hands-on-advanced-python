...
# sorted_DataSet = sorted(dataset, key = lambda x:x['snow'], reverse = True)
...
sorted_DataSet = sorted(dataset, key = lambda x:(x['snow'],x['awnd']), reverse = True)
pprint.pp(sorted_DataSet)